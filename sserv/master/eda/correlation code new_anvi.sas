...
proc printto log="&output_path/corr_log.log";
run;
													...
													%do;
														if _n_ = 1 then
															...
															do;
																if &&x_var&a.. ^= . then
																	do;
																		ad_%substr(&&x_var&a, 1, 24)_%scan(&decay_names,&decay_var,"!!") = &&x_var&a.. + ((%scan(&decay_rates,&decay_var,"!!"))*(ad_%substr(&&x_var&a, 1, 24)_%scan(&decay_names,&decay_var,"!!")));
																	end;
																else if &&x_var&a.. = . then
																	do;
																		ad_%substr(&&x_var&a, 1, 24)_%scan(&decay_names,&decay_var,"!!") = 0 + ((%scan(&decay_rates,&decay_var,"!!"))*(ad_%substr(&&x_var&a, 1, 24)_%scan(&decay_names,&decay_var,"!!")));
																	end;
															end;
													%end;
												...
												%if "&adstock_type." = "log" %then
													%do;
														if _n_ = 1 then
															...
															do;
																ad_%substr(&&x_var&a, 1, 24)_%scan(&decay_names,&decay_var,"!!") = log(&&x_var&a..) + ((%scan(&decay_rates,&decay_var,"!!"))*(ad_%substr(&&x_var&a, 1, 24)_%scan(&decay_names,&decay_var,"!!")));
															end;
													%end;
											%end;
										%end;
